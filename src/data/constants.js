...
export const Bio = {
  ...
  facebook: "https://www.facebook.com/mohamed.ahlan.921",
};
...
export const skills = [
  {
    ...
    skills: [
      ...
      },
      {
        name: "Material UI",
        image:
          "https://raw.githubusercontent.com/mui/material-ui/master/docs/public/static/logo.png",
      },
      {
        name: "Flutter",
        image:
...
export const education = [
  ...
  },
  {
    id: 1,
    img: scl,
    school: "Baduriya College, Mawanella",
    date: "2018 - 2020",
...
export const projects = [
  ...
  },
  {
    ...
    description:
      "The automotive industry is evolving through IoT and data analytics to optimize vehicle management. This project focuses on vehicle tracking, predictive maintenance, personalized advice, and parts recommendations. Neural Network-Based Chatbot: Develop an AI chatbot that provides real-time, personalized vehicle advice, using neural networks for accurate recommendations and an intuitive user interface.",
    image: chatbot,
  ...
  },
  {
    ...
    date: "Mar 2023 - Jul 2023",
    description:
      "Developed a mobile application for online retail, enabling users to browse products, make purchases, and track orders. Built with Kotlin for the frontend and Firebase for backend services, including user authentication, real-time database, and storage. This was a 2-member group project.",
    image: ora,
    ...
    member: [
      ...
      },
      {
        ...
        img: "https://avatars.githubusercontent.com/u/99311998?v=4",
